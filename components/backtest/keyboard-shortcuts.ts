...
export const BACKTEST_KEYBOARD_SHORTCUTS: KeyboardShortcut[] = [
  ...
  { keys: "Alt + T", description: "Trend line tool" },
  { keys: "Alt + H", description: "Horizontal line tool" },
  { keys: "Alt + V", description: "Vertical line tool" },
  { keys: "Alt + R", description: "Rectangle tool" },
  { keys: "Alt + F", description: "Fib retracement tool" },
  { keys: "Alt + M", description: "Measure tool" },
  { keys: "Alt + X", description: "Text note tool" },
