                ...
                <button
                  ...
                  className={cn(
                    ...
                    isSelected
                      ...
                      : "border-slate-200/80 bg-background/60 text-muted-foreground hover:border-primary/40 hover:bg-primary/10 hover:text-primary dark:border-slate-700/70",
                  )}
                ...
                <button
                  ...
                  className={cn(
                    ...
                    isSelected
                      ...
                      : "border-slate-200/80 bg-background/60 hover:border-amber-500/40 hover:bg-amber-500/10 dark:border-slate-700/70",
                  )}
