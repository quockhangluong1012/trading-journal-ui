...
import { Users, ShieldCheck, Activity, Users2, Loader2, Database } from "lucide-react";
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
        ...
        <Card className="bg-card">
          <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
            <CardTitle className="text-sm font-medium">Backtest Data</CardTitle>
            <Database className="h-4 w-4 text-muted-foreground" />
          </CardHeader>
          <CardContent>
            <div className="text-2xl font-bold">Assets Hub</div>
            <Link href="/admin/assets" className="text-xs text-blue-500 hover:underline flex items-center gap-1 mt-1">
              Manage Data Assets &rarr;
            </Link>
          </CardContent>
        </Card>
      </div>
